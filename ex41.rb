...
# :death is a symbol
# :death is also a key in a key value pair
# method(:deadh) is a ?
ROOMS = {
  :death => method(:death),
...
def runner(map, start)
  ...
  while true
    # The first time around assign the value at key ROOMS[:central_corridor] which is the methodobject central_corridor
    room = map[next_one]
    puts "\n----------"

    # The first time around invoke the method central_corridor
    next_one = room.call()
  end
end
